...
const CollectionProductsSectionChunk = loadable(() => import(/* webpackChunkName:"CollectionProductsSectionChunk" */ './collection-products.jsx'));
...
const getbundle = (type) => {
        ...
        case 'collection-products':
            return (props) => <CollectionProductsSectionChunk {...props}/>;
...
export default {
        ...
        'collection-products': { ...CollectionProductsSectionChunk, Component: getbundle('collection-products') },
